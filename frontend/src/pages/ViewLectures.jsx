...
//     // Derive selectedCourse from Redux so socket updates are reflected instantly.
//     const safeData = Array.isArray(courseData) ? courseData : []
//     const selectedCourse = safeData.find(c => c._id === courseId)

//     const [creatorData, setCreatorData] = useState(null)

//     // Store only the lecture _id so that when socket updates a lecture object,
//     // we automatically get the freshest version via the selector below.
//     const [selectedLectureId, setSelectedLectureId] = useState(null)

//     // Always resolve from the live lectures list — never stale.
...
//             // Otherwise default to first lecture
...
//             <div className='min-h-screen p-4 md:p-6 flex flex-col md:flex-row gap-6 relative overflow-hidden' style={{ background: '#0F172A' }}>

//                 {/* Background glow orbs */}
//                 <div className='fixed top-[-80px] right-[10%] w-[400px] h-[400px] bg-[#8B5CF6] opacity-[0.06] rounded-full blur-[140px] pointer-events-none z-0' />
...
//                             </button>
//                             <span style={{ background: 'linear-gradient(90deg, #E2E8F0, #94A3B8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
...
//                             // key forces remount when src changes so old video doesn't linger
...
//                             <p className='text-[#94A3B8] text-sm uppercase tracking-wider mb-1'>Now Playing</p>
...
//                         <div>
//                             <h3 className='text-base font-bold text-[#E2E8F0]'>Let's test your knowledge</h3>
//                             <p className='text-sm text-[#94A3B8] mt-1'>AI-generated Assessment cover content from the entire course.
//                             Generate your certificate after passing the quiz.</p>
//                         </div>
//                         <button
...
//                         <h2 className='text-xl font-bold' style={{ background: 'linear-gradient(90deg, #E2E8F0, #94A3B8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
//                             All Lectures
//                         </h2>
...
//                                             {index + 1}
//                                         </span>
//                                         <span className='text-base font-medium truncate max-w-[170px]'
            ...
            <div className='min-h-screen p-4 md:p-6 flex flex-col md:flex-row gap-6 relative overflow-hidden' style={{ background: '#0F172A' }}>
                ...
                <div className='w-full md:w-2/3 rounded-2xl p-6 relative z-[1]'
                    ...
                    <div className='mt-2 mb-6 p-5 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative overflow-hidden'
                        ...
                        <div>
                            <h3 className='text-base font-bold text-[#E2E8F0]'>Let's test your knowledge</h3>
                            <p className='text-sm text-[#b8b894] mt-1'>AI-generated Assessment covers content from the <span className='text-[#b89494] font-bold' >COMPLETE COURSE</span>.
