...
//     // New course published → add to student course list
//     socket.on("course_published", (course) => {
//       const current = Array.isArray(courseData) ? courseData : []
//       if (current.some(c => c._id === course._id)) return
//       dispatch(setCourseData([...current, course]))
//     })

//     // Course updated → update card on student side
...
//     // Course deleted or unpublished → remove from student list
...
//     // Lecture added → update lectures inside course
...
//     // Lecture updated → update specific lecture inside course
...
//     // Lecture removed → remove from course lectures
...
//     // Student enrolled → update educator dashboard enrollment count live
//     socket.on("student_enrolled", ({ courseId, creatorId, enrolledCount }) => {
//       if (userData?._id === creatorId) {
//         const current = Array.isArray(creatorCourseData) ? creatorCourseData : []
...
//     }
//   }, [userData, courseData, creatorCourseData])
